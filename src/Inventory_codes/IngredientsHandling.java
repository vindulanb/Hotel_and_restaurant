 ...
 * @author Tharindu NR
 */
public class IngredientsHandling extends javax.swing.JInternalFrame {
     Connection con =null;
    PreparedStatement pst = null;
    ResultSet rs =null;

    /**
     * Creates new form IngredientsHandling
     */
    public IngredientsHandling() {
        initComponents();
        con=Dbconnecter.con();
     ...
     public void tableload()
        {
            try 
            {
                String sql = "SELECT itemno,itemname,quantity,unitprice,status FROM ingredients";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ingredients Handling");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String status=jTextField4.getText();
        ...
        try {
            ...
            String q = "INSERT INTO ingredients (itemno,itemname,quantity,unitprice,status)"
                    + " values ('"+itemno+"','"+itemname+"','"+quantity+"','"+unitprice+"','"+status+"')";
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try
        {
            ...
            {
                String qv = "SELECT itemno,itemname,quantity,unitprice,status FROM ingredients WHERE itemname='"+itemname+"' OR  itemno = '"+itemno+"'";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(y==0)
        {
            ...
            try
            {
                String qd = "DELETE FROM ingredients WHERE itemno= '"+itemno+"'";
...
//            jLabel11.setText("");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(x==0)
        {
            ...
            try
            {
                String sql = "UPDATE ingredients SET itemno='"+itemno+"',itemname='"+itemname+"',quantity='"+quantity+"',unitprice='"+unitprice+"',status='"+status+"' WHERE  itemno='"+itemno+"'OR itemname='"+itemname+"'";
...
//           jLabel7.setText("");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
       GenReport(jTable1, "Ingredients Details","Ingredients", "IngredientReport.pdf");
      
    }//GEN-LAST:event_jButton6ActionPerformed

    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
       
        jTextField1.setText("Coconut Oil");
        jTextField2.setText("150");
        jTextField3.setText("20");
        jTextField4.setText("Very Good");
